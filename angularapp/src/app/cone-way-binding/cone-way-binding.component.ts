...
@Component({
  selector: 'app-cone-way-binding',
  templateUrl: './cone-way-binding.component.html',
  styleUrls: ['./cone-way-binding.component.css']
})
export class ConeWayBindingComponent implements OnInit {
